...
process ART_ILLUMINA_PAIRED_END {
    ...
    # No min max set for bbnorm, also min referes to kmer depth not read depth so leaving it at default.
    bbnorm.sh in=out_1.fq in2=out_2.fq out=art_out_1.fq out2=art_out_2.fq target=50 threads=$task.cpus -Xmx8g
    """
}
